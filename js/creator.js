...
export async function renderCreatorConsole() {
    ...
    container.querySelector("#creatorSuperPdpProduction").addEventListener("click", () => renderAccounting("electronic"));
...
async function renderCreatorEInvoicingMonitoring() {
    ...
    const { compliance = {}, subscriptions = {}, connections = [], transmissionStatuses = [] } = result.data || {};
