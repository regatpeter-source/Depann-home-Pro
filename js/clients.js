...
import { addClientActivity, deleteLocalClient, getLocalClients, saveLocalClient, synchronizeClients } from "./client-sync.js?v=85";
import { renderClientMessages } from "./messages.js?v=85";
