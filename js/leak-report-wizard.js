...
export function openLeakReportCreation() {
    ...
    dialog.querySelector("[data-report-from-appointment]").addEventListener("click", async () => { dialog.remove(); const { renderCalendar } = await import("./calendar.js?v=148"); renderCalendar(); });
...
async function validateReport(shell) {
    ...
    const { renderCalendar } = await import("./calendar.js?v=148");
    renderCalendar();
}
