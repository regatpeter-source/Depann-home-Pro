...
function renderDirectory(shell) {
    ...
    shell.querySelector("[data-edit-report-template]")?.addEventListener("click", () => window.dispatchEvent(new CustomEvent("depannhome:edit-report-template")));
}
