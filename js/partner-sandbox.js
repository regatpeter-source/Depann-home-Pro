...
function statusLabel(value) { return ({ accepted: "Acceptée", rejected: "Refusée", assigned: "Affectée", scheduled: "Planifiée", report_completed: "Rapport terminé", invoice_sent: "Facture envoyée", closed: "Clôturée", cancelled: "Annulée" })[value] || value; }
function priorityLabel(value) { return ({ low: "faible", normal: "normale", high: "haute", urgent: "urgente" })[value] || value; }
function documentLabel(value) { return ({ quote: "Devis", report: "Rapport", photo: "Photo", invoice: "Facture" })[value] || "Document"; }
function documentStatus(value) { return ({ pending: "En attente", completed: "Terminé", available: "Disponible", draft: "Brouillon", issued: "Émise", accepted: "Accepté", rejected: "Refusé" })[value] || value; }
