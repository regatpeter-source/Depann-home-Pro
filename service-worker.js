const CACHE_NAME = "depann-home-pro-v488";
const ASSETS = [
    "./",
    "./index.html",
    "./css/style.css?v=241",
    ...
    "./js/partner-missions.js?v=70",
    "./js/partner-sandbox.js",
    "./js/partner-dialogue.js?v=19",
    "./js/partner-connections.js?v=34",
    "./js/partner-email-settings.js?v=26",
    "./js/technical-reports.js?v=7",
    "./js/auth.js?v=125",
    "./js/billing.js?v=192",
    ...
    "./js/calendar.js?v=192",
    "./js/clients.js?v=158",
    "./js/client-sync.js?v=126",
    "./js/collaboration.js?v=5",
    "./js/leak-report-wizard.js?v=39",
    "./js/config.js?v=131",
    "./js/data.js",
    "./js/data-imports.js?v=4",
    "./js/navigation.js?v=423",
    "./js/library.js",
    "./js/local-library.js",
