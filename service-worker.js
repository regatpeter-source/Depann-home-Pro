const CACHE_NAME = "depann-home-pro-v583";
const ASSETS = [
    "./",
    "./connexion",
    "./index.html",
    ...
    "./js/partner-missions.js?v=89",
    "./js/partner-sandbox.js",
    "./js/partner-dialogue.js?v=19",
    "./js/partner-connections.js?v=49",
    "./js/partner-email-settings.js?v=30",
    "./js/technical-reports.js?v=21",
    "./js/auth.js?v=130",
    "./js/billing.js?v=209",
