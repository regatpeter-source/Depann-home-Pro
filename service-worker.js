const CACHE_NAME = "depann-home-pro-v492";
const ASSETS = [
    "./",
    "./index.html",
    "./css/style.css?v=243",
    "./css/partner-dialogue.css?v=6",
    "./css/report-editor.css?v=7",
    "./css/health-dashboard.css?v=1",
    "./js/app.js?v=394",
    "./js/client-session.js?v=4",
    "./js/accounting.js?v=20",
    "./js/groups.js?v=4",
    "./js/health-dashboard.js?v=1",
    "./js/connectors.js?v=2",
    "./js/partner-missions.js?v=74",
    "./js/partner-sandbox.js",
    "./js/partner-dialogue.js?v=19",
    "./js/partner-connections.js?v=38",
    "./js/partner-email-settings.js?v=26",
    "./js/technical-reports.js?v=11",
    "./js/auth.js?v=125",
    "./js/billing.js?v=196",
    ...
    "./js/calendar.js?v=196",
    "./js/clients.js?v=159",
    "./js/client-sync.js?v=126",
    "./js/collaboration.js?v=5",
    "./js/leak-report-wizard.js?v=43",
    "./js/config.js?v=131",
    "./js/data.js",
    "./js/data-imports.js?v=4",
    "./js/navigation.js?v=427",
    "./js/library.js",
    "./js/local-library.js",
    "./js/messages.js?v=107",
    "./js/platform-announcement.js",
    "./js/purchases.js?v=122",
