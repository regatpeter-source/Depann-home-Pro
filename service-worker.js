const CACHE_NAME = "depann-home-pro-v599";
const ASSETS = [
    "./",
    "./connexion",
    "./index.html",
    ...
    "./js/partner-missions.js?v=92",
    "./js/partner-sandbox.js",
    "./js/partner-dialogue.js?v=19",
    "./js/partner-connections.js?v=52",
    "./js/partner-email-settings.js?v=30",
    "./js/technical-reports.js?v=23",
    "./js/auth.js?v=130",
    "./js/billing.js?v=214",
    ...
    "./js/i18n.js?v=6",
    "./js/leak-report-wizard.js?v=60",
    "./js/config.js?v=135",
    "./js/data.js",
    "./js/data-imports.js?v=6",
    "./js/navigation.js?v=501",
    "./js/creator.js?v=170",
