const CACHE_NAME = "depann-home-pro-v452";
const ASSETS = [
    "./",
    "./index.html",
    "./css/style.css?v=222",
    ...
    "./js/calendar.js?v=179",
    "./js/clients.js?v=152",
    "./js/client-sync.js?v=125",
    "./js/collaboration.js?v=5",
    "./js/leak-report-wizard.js?v=31",
    "./js/config.js?v=131",
    "./js/data.js",
    "./js/data-imports.js?v=4",
    "./js/navigation.js?v=395",
    "./js/library.js",
    "./js/local-library.js",
