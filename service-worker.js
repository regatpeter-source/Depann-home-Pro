const CACHE_NAME = "depann-home-pro-v497";
const ASSETS = [
    "./",
    "./index.html",
    "./css/style.css?v=245",
    ...
    "./js/accounting.js?v=23",
    "./js/groups.js?v=4",
    "./js/health-dashboard.js?v=1",
    "./js/connectors.js?v=2",
    "./js/partner-missions.js?v=77",
    "./js/partner-sandbox.js",
    "./js/partner-dialogue.js?v=19",
    "./js/partner-connections.js?v=41",
    "./js/partner-email-settings.js?v=27",
    "./js/technical-reports.js?v=14",
    "./js/auth.js?v=125",
    "./js/billing.js?v=200",
