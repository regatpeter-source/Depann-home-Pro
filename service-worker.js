const CACHE_NAME = "depann-home-pro-v498";
const ASSETS = [
    "./",
    "./index.html",
    "./css/style.css?v=245",
    ...
    "./js/partner-missions.js?v=78",
    "./js/partner-sandbox.js",
    "./js/partner-dialogue.js?v=19",
    "./js/partner-connections.js?v=42",
    "./js/partner-email-settings.js?v=27",
    "./js/technical-reports.js?v=15",
    "./js/auth.js?v=125",
    "./js/billing.js?v=201",
    ...
    "./js/calendar.js?v=200",
    "./js/clients.js?v=164",
    "./js/client-sync.js?v=127",
    "./js/collaboration.js?v=5",
    "./js/leak-report-wizard.js?v=47",
    "./js/config.js?v=131",
    "./js/data.js",
    "./js/data-imports.js?v=5",
    "./js/navigation.js?v=431",
    "./js/library.js",
    "./js/local-library.js",
