const CACHE_NAME = "depann-home-pro-v470";
const ASSETS = [
    "./",
    "./index.html",
    "./css/style.css?v=226",
    ...
    "./js/partner-missions.js?v=64",
    "./js/partner-sandbox.js",
    "./js/partner-dialogue.js?v=19",
    "./js/partner-connections.js?v=29",
    "./js/partner-email-settings.js?v=22",
    "./js/technical-reports.js?v=5",
    "./js/auth.js?v=125",
    "./js/billing.js?v=189",
    ...
    "./js/calendar.js?v=187",
    "./js/clients.js?v=155",
    "./js/client-sync.js?v=125",
    "./js/collaboration.js?v=5",
    "./js/leak-report-wizard.js?v=36",
    "./js/config.js?v=131",
    "./js/data.js",
    "./js/data-imports.js?v=4",
    "./js/navigation.js?v=410",
    "./js/library.js",
    "./js/local-library.js",
