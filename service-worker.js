const CACHE_NAME = "depann-home-pro-v581";
const ASSETS = [
    "./",
    "./connexion",
    "./index.html",
    ...
    "./js/partner-missions.js?v=87",
    "./js/partner-sandbox.js",
    "./js/partner-dialogue.js?v=19",
    "./js/partner-connections.js?v=47",
    "./js/partner-email-settings.js?v=30",
    "./js/technical-reports.js?v=19",
    "./js/auth.js?v=130",
    "./js/billing.js?v=207",
