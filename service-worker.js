const CACHE_NAME = "depann-home-pro-v422";
const ASSETS = [
    "./",
    "./index.html",
    "./css/style.css?v=217",
    ...
    "./js/groups.js",
    "./js/connectors.js",
    "./js/partner-missions.js?v=48",
    "./js/partner-sandbox.js",
    "./js/partner-dialogue.js",
    "./js/partner-connections.js?v=24",
    "./js/partner-email-settings.js?v=10",
