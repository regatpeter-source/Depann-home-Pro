const CACHE_NAME = "depann-home-pro-v544";
const ASSETS = [
    "./",
    "./connexion",
    "./index.html",
    ...
    "./js/calendar.js?v=218",
    "./js/intervention-search.js?v=1",
    "./js/clients.js?v=165",
    "./js/client-sync.js?v=128",
    "./js/collaboration.js?v=7",
    "./js/i18n.js?v=5",
    "./js/leak-report-wizard.js?v=52",
    "./js/config.js?v=135",
    "./js/data.js",
    "./js/data-imports.js?v=5",
    "./js/navigation.js?v=459",
    "./js/creator.js?v=161",
    "./js/library.js",
    "./js/local-library.js",
