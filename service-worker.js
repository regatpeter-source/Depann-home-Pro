const CACHE_NAME = "depann-home-pro-v453";
const ASSETS = [
    "./",
    "./index.html",
    "./css/style.css?v=222",
    ...
    "./js/connectors.js",
    "./js/partner-missions.js?v=56",
    "./js/partner-sandbox.js",
    "./js/partner-dialogue.js?v=17",
    "./js/partner-connections.js?v=25",
    "./js/partner-email-settings.js?v=18",
    "./js/technical-reports.js?v=3",
    "./js/auth.js?v=123",
    "./js/billing.js?v=186",
    ...
    "./js/calendar.js?v=180",
    "./js/clients.js?v=153",
    "./js/client-sync.js?v=125",
    "./js/collaboration.js?v=5",
    "./js/leak-report-wizard.js?v=32",
    "./js/config.js?v=131",
    "./js/data.js",
    "./js/data-imports.js?v=4",
    "./js/navigation.js?v=396",
    "./js/library.js",
    "./js/local-library.js",
