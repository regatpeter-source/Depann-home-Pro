const CACHE_NAME = "depann-home-pro-v490";
const ASSETS = [
    "./",
    "./index.html",
    "./css/style.css?v=242",
    ...
    "./js/partner-missions.js?v=72",
    "./js/partner-sandbox.js",
    "./js/partner-dialogue.js?v=19",
    "./js/partner-connections.js?v=36",
    "./js/partner-email-settings.js?v=26",
    "./js/technical-reports.js?v=9",
    "./js/auth.js?v=125",
    "./js/billing.js?v=194",
    ...
    "./js/calendar.js?v=194",
    "./js/clients.js?v=159",
    "./js/client-sync.js?v=126",
    "./js/collaboration.js?v=5",
    "./js/leak-report-wizard.js?v=41",
    "./js/config.js?v=131",
    "./js/data.js",
    "./js/data-imports.js?v=4",
    "./js/navigation.js?v=425",
    "./js/library.js",
    "./js/local-library.js",
