const CACHE_NAME = "depann-home-pro-v466";
const ASSETS = [
    "./",
    "./index.html",
    "./css/style.css?v=225",
    ...
    "./js/partner-missions.js?v=61",
    "./js/partner-sandbox.js",
    "./js/partner-dialogue.js?v=19",
    "./js/partner-connections.js?v=27",
    "./js/partner-email-settings.js?v=21",
