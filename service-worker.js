const CACHE_NAME = "depann-home-pro-v502";
const ASSETS = [
    "./",
    "./index.html",
    "./css/style.css?v=249",
    ...
    "./js/calendar.js?v=201",
    "./js/clients.js?v=164",
    "./js/client-sync.js?v=127",
    "./js/collaboration.js?v=6",
    "./js/leak-report-wizard.js?v=48",
    "./js/config.js?v=132",
    "./js/data.js",
