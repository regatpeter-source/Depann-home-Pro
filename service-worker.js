const CACHE_NAME = "depann-home-pro-v577";
const ASSETS = [
    "./",
    "./connexion",
    "./index.html",
    ...
    "./js/partner-missions.js?v=84",
    "./js/partner-sandbox.js",
    "./js/partner-dialogue.js?v=19",
    "./js/partner-connections.js?v=46",
    ...
    "./js/calendar.js?v=224",
    "./js/intervention-search.js?v=1",
    "./js/clients.js?v=169",
    "./js/client-sync.js?v=131",
    "./js/collaboration.js?v=12",
    "./js/i18n.js?v=5",
    "./js/leak-report-wizard.js?v=53",
    "./js/config.js?v=135",
    "./js/data.js",
    "./js/data-imports.js?v=6",
    "./js/navigation.js?v=485",
    "./js/creator.js?v=170",
