...
function drawBox(page, zone, size) { if (zone.style.eraseSource) page.drawRectangle({ x: zone.x, y: size.height - zone.y - zone.height, width: zone.width, height: zone.height, color: pdfColor(zone.style.backgroundColor, "#ffffff") }); if (zone.style.borderColor && zone.style.borderWidth) page.drawRectangle({ x: zone.x, y: size.height - zone.y - zone.height, width: zone.width, height: zone.height, borderColor: pdfColor(zone.style.borderColor), borderWidth: zone.style.borderWidth }); }
