...
export const DOCUMENT_TEMPLATE_FIELDS = Object.freeze({
    quote: ["QUOTE_NUMBER", "company.name", "company.address", "company.postalCode", "company.city", "company.phone", "company.email", "company.siret", "company.vat", "company.logo", "client.name", "client.firstName", "client.company", "client.address", "client.postalCode", "client.city", "client.phone", "client.email", "client.siren", "client.vat", "client.deliveryAddress", "document.type", "document.number", "document.quoteNumber", "document.author", "document.date", "document.validUntil", "document.serviceDate", "document.purchaseOrderReference", "document.interventionReference", "document.insuranceDossier", "document.mandateNumber", "document.claimNumber", "document.insuredNumber", "document.principal", "document.manager", "document.expert", "document.operationCategory", "document.subject", "document.lines", "document.discountLabel", "document.discount", "document.aids", "document.deposit", "document.subtotal", "document.vat", "document.total", "document.balance", "document.conditions", "document.signature"],
    invoice: ["INVOICE_NUMBER", "company.name", "company.address", "company.postalCode", "company.city", "company.phone", "company.email", "company.siret", "company.vat", "company.logo", "client.name", "client.firstName", "client.company", "client.address", "client.postalCode", "client.city", "client.phone", "client.email", "client.siren", "client.vat", "client.deliveryAddress", "document.type", "document.number", "document.invoiceNumber", "document.author", "document.date", "document.dueDate", "document.serviceDate", "document.purchaseOrderReference", "document.interventionReference", "document.insuranceDossier", "document.mandateNumber", "document.claimNumber", "document.insuredNumber", "document.principal", "document.manager", "document.expert", "document.operationCategory", "document.lines", "document.discountLabel", "document.discount", "document.aids", "document.deposit", "document.subtotal", "document.vat", "document.total", "document.balance", "document.status", "document.payment"],
...
export function buildBillingCustomModel(document, profile = {}) {
    ...
    return {
        ...
        client: { name: clientName, firstName: currentClient.firstName || "", company: currentClient.company || currentClient.companyName || (document.customerType === "Professionnel" ? clientName : ""), address: legal.billingAddress || clientAddress, postalCode: currentClient.postalCode || "", city: currentClient.city || "", phone: currentClient.phone || "", email: currentClient.email || "", siren: legal.customerSiren || "", vat: legal.customerVatNumber || "", deliveryAddress: legal.deliveryAddress || "" },
