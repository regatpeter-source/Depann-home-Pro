...
export const DOCUMENT_TEMPLATE_FIELDS = Object.freeze({
    quote: ["QUOTE_NUMBER", "company.name", "company.address", "company.postalCode", "company.city", "company.phone", "company.email", "company.siret", "company.vat", "company.logo", "client.name", "client.firstName", "client.company", "client.address", "client.postalCode", "client.city", "client.phone", "client.email", "client.siren", "client.vat", "client.deliveryAddress", "document.type", "document.number", "document.quoteNumber", "document.author", "document.date", "document.validUntil", "document.serviceDate", "document.purchaseOrderReference", "document.operationCategory", "document.subject", "document.lines", "document.discountLabel", "document.discount", "document.aids", "document.deposit", "document.subtotal", "document.vat", "document.total", "document.balance", "document.conditions", "document.signature"],
    invoice: ["INVOICE_NUMBER", "company.name", "company.address", "company.postalCode", "company.city", "company.phone", "company.email", "company.siret", "company.vat", "company.logo", "client.name", "client.firstName", "client.company", "client.address", "client.postalCode", "client.city", "client.phone", "client.email", "client.siren", "client.vat", "client.deliveryAddress", "document.type", "document.number", "document.invoiceNumber", "document.author", "document.date", "document.dueDate", "document.serviceDate", "document.purchaseOrderReference", "document.operationCategory", "document.lines", "document.discountLabel", "document.discount", "document.aids", "document.deposit", "document.subtotal", "document.vat", "document.total", "document.balance", "document.status", "document.payment"],
    quitus: ["QUITUS_NUMBER", "company.name", "company.address", "company.phone", "company.email", "company.logo", "client.name", "client.address", "client.city", "client.phone", "client.email", "document.type", "document.number", "document.quitusNumber", "document.technician", "document.intervention", "document.date", "document.services", "document.legalText", "document.observations", "document.approval", "document.approved", "document.signature"],
