...
test("desktop stylesheet cache versions remain synchronized", () => {
    assert.match(index, /css\/style\.css\?v=272/);
    assert.match(index, /js\/app\.js\?v=452/);
    assert.match(serviceWorker, /css\/style\.css\?v=272/);
    assert.match(serviceWorker, /js\/app\.js\?v=452/);
    assert.match(serviceWorker, /js\/clients\.js\?v=169/);
    assert.match(serviceWorker, /js\/client-sync\.js\?v=131/);
    assert.match(serviceWorker, /js\/navigation\.js\?v=478/);
    assert.match(serviceWorker, /js\/creator\.js\?v=168/);
    assert.match(serviceWorker, /js\/i18n\.js\?v=5/);
    assert.match(serviceWorker, /depann-home-pro-v568/);
});