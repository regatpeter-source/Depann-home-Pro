...
Le Centre d’assistance Créateur ne transforme pas le Créateur en Poste Admin de l’entreprise. Il fournit une vue technique temporaire en lecture seule et des réparations séparées, motivées et auditables. Les Postes Admin actifs sont notifiés de l’ouverture, de la fermeture et de chaque réparation. Pendant une prise en main acceptée, l’entreprise voit automatiquement la page suivie, le curseur et un journal en direct de chaque ouverture de page ou de fenêtre, commande, champ utilisé et opération applicative. Le contenu des champs, les textes métier, les identifiants d’objets et les secrets ne sont jamais retransmis. Une interaction locale arrête seulement le changement automatique de page : le journal reste visible jusqu’à la fin de la session. Voir [CREATOR_ASSISTANCE.md](CREATOR_ASSISTANCE.md).
