...
- Aucun connecteur fictif ou simulateur n’est proposé dans ce module. Chaque entreprise configure séparément le nom, l’URL HTTPS, l’identifiant contractuel et la clé API de la plateforme agréée qu’elle a choisie. Le transport générique envoie l’archive UBL avec une clé d’idempotence et journalise la réponse réelle. Le contrat API de la plateforme doit accepter ce dépôt UBL ; si son protocole diffère, un adaptateur fournisseur reste nécessaire pour l’envoi, la réception, les statuts de cycle de vie et l’e-reporting.
