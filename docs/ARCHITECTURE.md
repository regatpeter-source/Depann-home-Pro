...
- Les PDP sont des connecteurs isolés. Seul un connecteur de test est fourni : l’émission, l’UBL et l’archivage local ne constituent donc pas à eux seuls une transmission réglementaire. La mise en production exige le contrat et le connecteur d’une plateforme agréée choisie par l’entreprise, notamment pour l’envoi, la réception, les statuts de cycle de vie et l’e-reporting. Les échecs sont journalisés et renvoyables depuis l’interface.
