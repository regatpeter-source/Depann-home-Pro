...
L’interface **Partenaire** utilise le niveau technique Pro, mais son portail est **gratuit** : tarif mensuel à 0 €, aucune échéance et aucune facture d’abonnement. Elle comprend exactement **un poste Administrateur PC et aucun poste mobile**. Son espace métier est volontairement limité à **Clients** et **Missions partenaires** ; la messagerie contextuelle reste rattachée à ces dossiers. Lors d’une conversion, les accès supplémentaires sont désactivés sans suppression de leurs données. L’interface Groupe reste soumise à sa règle commerciale propre.
